...
public class LenPath extends CompoundFeature {
	...
	public String getname() {
		...
		return "LenClLoc:LenClCon:LenClSen:LenClNum:LenClJob:LenClVeh:LenClO:LenClOrg:LenClGpe:LenClFac:LenClPer:LenClCri";
	...
	public String getValue(AnnotatedToken t) {
		...
		for (int i=0;i<Ner.length;i++){
			String tmp2;
			if (shortestPath.get(Ner[i])==null) tmp2="-NULL-";
			else tmp2=String.valueOf(shortestPath.get(Ner[i]));
			if (i<Ner.length-1)
				shortPath+=tmp2+":";
			else shortPath+=tmp2;
		}
